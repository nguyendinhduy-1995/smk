...
const GOOGLE_MODELS = [
    { id: 'gemini-3.1-flash-image-preview', label: '🎨 Nano Banana 2 (Image Edit ⭐)', tier: 'flagship' },
    { id: 'gemini-3-pro-image-preview', label: '🎨 Nano Banana Pro (4K Image)', tier: 'flagship' },
    { id: 'gemini-2.5-flash-image', label: '🎨 Nano Banana (Image Fast)', tier: 'flagship' },
    { id: 'imagen-4.0-ultra-generate-001', label: '🖼 Imagen 4 Ultra (Text→Image)', tier: 'flagship' },
...
const INITIAL_FEATURES: AIFeature[] = [
    ...
    { name: 'AR Try-On', desc: 'Thử kính ảo bằng Nano Banana 2 (Google AI). Giữ 100% gương mặt gốc.', endpoint: '/try-on', enabled: true, usage: '312 lần thử', iconSvg: Icons.glasses, provider: 'google', model: 'gemini-3.1-flash-image-preview', temperature: 0, maxTokens: 256, systemPrompt: 'Xử lý ảnh thử kính. Giữ nguyên 100% gương mặt, chỉ phủ kính lên.', customInstructions: '' },
