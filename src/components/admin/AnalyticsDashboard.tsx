    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: 'var(--space-3)' }}>
                {[
                    { icon: '', label: 'LƯỢT XEM HÔM NAY', value: String(data.today.views), sub: `${data.today.uniqueVisitors} khách` },
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'var(--space-4)' }}>
                ...
                <div className="card" style={{ padding: 'var(--space-4)' }}>
                    ...
                    {(data?.today?.topPages?.length || 0) > 0 ? (data.today.topPages || []).map((p, i) => (
                ...
                <div className="card" style={{ padding: 'var(--space-4)' }}>
                    ...
                    {(data?.today?.topActions?.length || 0) > 0 ? (data.today.topActions || []).map((a, i) => {
